...
const App = () =>{
  ...
  const [modalVisiblerutaflores, setModalVisibleRutaFlores] = useState(false);
  return(
  <>
  <ScrollView>
    ...
    <Modal transparent={true} animationType='slide' visible={modalVisiblepupusa} onRequestClose={() => {alert('Modal has been closed.');}} >
      <View style={styles.vistaModal}>
        <View style={styles.Modal}>
          <Text style={styles.subtitulo}>Pupusas</Text>
          <Text>La pupusa es una tortilla gruesa a base de masa de maíz o de arroz rellena con uno o más ingredientes.</Text>
          <Button title="Cerrar" onPress={()=>{setModalVisiblePupusa(!modalVisiblepupusa)}}></Button>
        </View>
      </View>
    </Modal>

    <Modal transparent={true} animationType='slide' visible={modalVisiblerutaflores} onRequestClose={() => {alert('Modal has been closed.');}} >
      <View style={styles.vistaModal}>
        <View style={styles.Modal}>
          <Text style={styles.subtitulo}>Ruta de las Flores</Text>
          <Text>La Ruta de las Flores es un destino turístico en El Salvador que destaca por su belleza natural, pueblos coloniales, cultura cafetera y actividades de aventura.</Text>
          <Button title="Cerrar" onPress={()=>{setModalVisibleRutaFlores(!modalVisiblerutaflores)}}></Button>
        </View>
      </View>
    </Modal>
  ...
  <View style={styles.contenedor}>
    ...
    <View style={styles.listado}>
      <View style={styles.listaItem}>
        <TouchableHighlight onPress={()=>{setModalVisibleRutaFlores(!modalVisiblerutaflores)}}>
